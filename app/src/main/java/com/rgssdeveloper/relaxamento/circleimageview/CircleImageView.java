...
public class CircleImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    private void updateDimensions() {
        ...
        if (!mBorderOverlay && mBorderWidth > 0) {
            //20f controlls magnification, more negative, more magnification but use mDrawableRect bellow
            mDrawableRect.inset(mBorderWidth-20f, mBorderWidth-20f);
        }
        mDrawableRadius = Math.min(mDrawableRect.height() / 2.0f - 30f, mDrawableRect.width() / 2.0f -30f);
        //30f controls distance of border from circle
        //use mBorderRect instead of mDrawableRect for no resize circle
        updateShaderMatrix();
    }
